...
function TodayScreen({ c, state, setState, onOpenExercise, onSwap, onNotes }) {
...
function ExerciseCard({ c, lift, idx, state, setState, onOpenExercise, onSwap, onNotes }) {
...
function SetRow({ c, s, i, onToggle, setValue }) {
  return (
    <div style={{
      display: 'grid', gridTemplateColumns: '32px 1fr 1fr 48px',
